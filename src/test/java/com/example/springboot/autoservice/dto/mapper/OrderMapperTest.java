...
class OrderMapperTest {
    ...
    void setUp() throws ParseException {
        ...
        order.setAcceptanceDate(new SimpleDateFormat("yyyy-MM-dd").parse("2022-12-10"));
        ...
        order.setCompletionDate(new SimpleDateFormat("yyyy-MM-dd").parse("2022-22-10"));
        orderRequestDto = new OrderRequestDto();
        orderRequestDto.setCarId(1L);
        orderRequestDto.setDescription("Description");
        orderRequestDto.setAcceptanceDate(new SimpleDateFormat("yyyy-MM-dd").parse("2022-12-10"));
        ...
        orderRequestDto.setCompletionDate(new SimpleDateFormat("yyyy-MM-dd").parse("2022-22-10"));
    }

    @Test
    public void toDto_Ok() throws ParseException {
        ...
        Assertions.assertEquals(new SimpleDateFormat("yyyy-MM-dd").parse("2022-12-10"),
                    actual.getAcceptanceDate());
        ...
        Assertions.assertEquals(new SimpleDateFormat("yyyy-MM-dd").parse("2022-22-10"),
                    actual.getCompletionDate());
    }

    @Test
    public void toModel_Ok() throws ParseException {
        Car car = new Car();
        car.setId(1L);
